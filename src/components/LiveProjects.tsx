...
export default function CaseStudiesSection() {
    return (
        <section className="py-8 px-4 md:py-16 md:px-24 bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="bg-white rounded-2xl shadow-md p-4 md:p-6 relative flex flex-col">
                    <img src="/ecitizen_image.svg" alt="Case Study 1" className="rounded-lg w-full h-48 md:h-64 object-cover" />
                ...
                <div className="bg-white rounded-2xl shadow-md p-4 md:p-6 relative flex flex-col">
                    <img src="/milescoop.svg" alt="Case Study 2" className="rounded-lg w-full h-48 md:h-64 object-cover" />
                    <div className="mt-4 flex-1 flex flex-col">
