...
//     </section>
    ...
    <section className="flex flex-col items-center justify-center text-center ">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 fa-font-awesome text-black">
            Experience Genuine <br/> Innovation </h1>
        <p className="text-lg md:text-2xl text-gray-700 mb-16 fa-font-awesome py-2">
            Our leadership team at Webmasters Kenya Ltd is united by a shared commitment to
        ...
        <hr className="w-90 rounded-2xl border-yellow-400 mb-6"/>
        <img
            src="/image_group.svg"
            alt="Innovation"
            className="w-auto sm:w-full h-auto object-cover"
        />
    </section>
);
//
